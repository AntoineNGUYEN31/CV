...
\colorbox{bgcol}{\makebox[\mpwidth][c]{\HUGE{\textcolor{white}{\uppercase{Minh Quan NGUYEN}} } \textcolor{sectcol}{\rule[-1mm]{1mm}{0.9cm}} \HUGE{\textcolor{white}{\uppercase{Resume}} } }}
...
\colorbox{bgcol}{
	\parbox{0.5\linewidth}{
		\transparent{1}%
		\begin{center}
		\larrow{sectcol}\larrow{sectcol}\textcolor{white}{Currently Linux administrator of the Flight-Test Data Center of AIRBUS, I am looking for a DevOps Architect position in aeronautics or automobile}
		\end{center}
	}
}
\vspace{60pt}
...
Linux & DevOps PaaS Administrator, Master Degree & Engineer Degree in Aeronautics, focuses on Digital Transformation & Agile Transformation of IT developpement.
...
%
\cvevent{2019 - now}{Linux & DevOps PaaS Administrator}{Capgemini Toulouse}
{Develop the DevOps Platform as a Service on premise}
{Develop the Proof of Concept/ Demonstrator for DevOps on diffrent technologies}
{Redact the DevOps guide and best pratices}
{Provide support on migration from old school to DevOps}
{Provide support to end-users on traditional Linux Platform}
...
\cvevent{2013 - 2018}{Thermal Software Development Engineer / Thermal Simulation Engineer}{Altran Technologies Toulouse}

{Invented a flexible assessment framework, targeting industrial trainees}
{TOICA}
{Build numerical model & Performed thermal simultion to certificate the design of Aircraft (global model A350-900 , pre-cooler A320 NEO), electronic cards}
{Supervised internships on thermal software development, Recruited trainees}

%\textcolor{softcol}{\hrule}

%
\cvevent{2012 -2013}{Aerodynamics Software Developement Engineer}{Altran Technologies}
{Tool migration from Fortran to Python}
{Provided suport for Aero - Simulation platform & tools}
